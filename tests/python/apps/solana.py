...
class SolanaClient:
    ...
    def get_public_key(self, derivation_path : bytes) -> bytes:
        public_key:RAPDU = self._client.exchange(CLA, INS.INS_GET_PUBKEY, P1_NON_CONFIRM, P2_MORE, derivation_path)
    ...
    @contextmanager
    def send_async_sign_message(self, derivation_path : bytes, message: bytes) -> Generator[None, None, None]:
        ...
        with self._client.exchange_async(CLA, INS.INS_SIGN_MESSAGE, P1_CONFIRM, final_p2, message_splited_prefixed[-1]):
            yield
    ...
    def send_blind_sign_message(self, derivation_path : bytes, message: bytes) -> RAPDU:
        ...
        return self._client.exchange(CLA, INS.INS_SIGN_MESSAGE, P1_NON_CONFIRM, final_p2, message_splited_prefixed[-1])
